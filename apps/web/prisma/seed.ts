...
const PERMISSION_DEFINITIONS = [
  ...
  { permissionKey: "documents.view", permissionName: "View documents", category: "Content", description: "View document management pages." },
  { permissionKey: "documents.create", permissionName: "Create documents", category: "Content", description: "Create and upload documents." },
  { permissionKey: "documents.edit", permissionName: "Edit documents", category: "Content", description: "Edit document metadata and files." },
  { permissionKey: "documents.delete", permissionName: "Delete documents", category: "Content", description: "Delete uploaded documents." },
